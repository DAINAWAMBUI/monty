 ...
 * @delims: deliminators to use to delimit words
 * return: 2D array of pointers on each word
 */
char **strtow(char *str, char *delims)
{
	char **words = NULL;
...
/**
 * is_delim - checks if stream has deliminator char
 ...
 * @delims: deliminators to use to delimit word
 ...
 * @delims: deliminators to use to delimit words
 * returns: the pointer to first char of next word
 */
char *get_next_word(char *str, char *delims)
{
	int pending = 0;
